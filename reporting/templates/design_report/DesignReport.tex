...
% --------------------------------------------------------------------------------------
% --- Document Type ---
\newcommand{\DocumentType}{PRODUCT DESIGN DOCUMENT}     % Often not necessary to change.
...
% TODO: Add content introducing the finalised requirements.
% Presents the refined and categorised requirements derived from the brief and research.
...
% TODO: Analyse the cost implications of the design.
