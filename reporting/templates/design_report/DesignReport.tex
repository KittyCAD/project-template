...
\newcommand{\ReportTitle}{DESIGN REPORT TITLE} % Changed: e.g., INITIAL DESIGN DOCUMENTATION
...
\newcommand{\LogoPath}{./assets/logo.pdf}     % Path to your logo file (ensure ./assets/ exists or change 
\newcommand{\ReferenceFile}{DesignReport.bib} % Changed: Name of your BibTeX file
% --------------------------------------------------------------------------------------
